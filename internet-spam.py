...
def main():
    ...
    os.system ('figlet Spammer Terbaru')
    ...
    print'[92m[[97m1[92m] [97mSpammer Terbaru '
    ...
    if gans in ['1']:
        ...
        os.system ('git clone https://github.com/BladeKnife/spamer ')

        print 

        print (' [+] Silakan ketik cd spamer')

        print (' [+] Silakan ketik python spam.py')
